...
namespace Pb.Wechat.Web.Areas.AppAreaName.Controllers
{
    ...
    public class CustomerServiceResponseTextsController : AbpZeroTemplateControllerBase
    {
        ...
        public CustomerServiceResponseTextsController(ICustomerServiceResponseTextAppService CustomerServiceResponseTextAppService, IUserMpAppService userMpAppService, IFileServer fileServer, IWxMediaUpload wxMediaUpload)
        {
        ...
        public async Task<PartialViewResult> CreateOrEditModal(int id)
        {
            ...
            {
                var mpid = await _userMpAppService.GetDefaultMpId();
                return PartialView("_CreateOrEditModal", new CreateOrEditCustomerServiceResponseTextViewModel() { MpID = mpid,ReponseContentType= (int)CustomerServiceMsgType.text });
            }
