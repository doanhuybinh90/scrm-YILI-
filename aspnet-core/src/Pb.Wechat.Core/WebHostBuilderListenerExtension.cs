...
namespace Pb.Wechat
{
    public static class WebHostBuilderListenerExtension
    {
        public static IWebHostBuilder BindUrls(this IWebHostBuilder hostBuilder, string[] appLaunchArgs, string contentRoot)
        {
            ...
            Console.WriteLine(string.Format("input start args: {0}", Abp.Json.JsonSerializationHelper.SerializeWithType(appLaunchArgs)));
            ...
            {
                string hostingFile = Path.Combine(contentRoot, "hosting.json");
